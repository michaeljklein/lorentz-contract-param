...
unit_ParseContracts :: Expectation
unit_ParseContracts = do
...
unit_StringLiteral :: Expectation
unit_StringLiteral = do
...
unit_PairConstructor :: Expectation
unit_PairConstructor = do
