...
unit_GoodContracts :: Assertion
unit_GoodContracts = mapM_ (checkFile [] True) =<< getWellTypedContracts

unit_BadContracts :: Assertion
unit_BadContracts = mapM_ (checkFile [] False) =<< getIllTypedContracts
...
unit_UnreachableCode :: Assertion
unit_UnreachableCode = do
