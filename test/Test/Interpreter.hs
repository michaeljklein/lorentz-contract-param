...
--    PUSH nat 12
--    ADD;
_myInstr :: Typeable s => Instr ('T_c 'CInt : s) ('T_c 'CInt : s)
_myInstr =
  PUSH (VC $ CvInt 223) #
  SOME #
  IF_NONE DUP SWAP #
...
_myInstr2 :: Typeable a => Instr a ('T_option ('T_c 'CInt) : a)
_myInstr2 =
