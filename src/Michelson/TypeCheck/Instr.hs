...
import Michelson.Typed
  ((:+>)(..), Abs, And, CT(..), Contract, ContractInp, ContractOut, Eq', Ge, Gt, Instr, IterOp(..),
  Le, Lsl, Lsr, Lt, MapOp(..), Neg, Neq, Not, Notes(..), Notes'(..), Or, Sing(..), T(..),
  TContract, Tc, Value(..), Xor, converge, convergeAnns, extractNotes, fromUType, mkNotes,
  notesCase, orAnn, withSomeSingCT, withSomeSingT, ( # ))
...
typeCheckValue
  ...
  -> T
  -> TypeCheckT SomeVal
typeCheckValue = typeCheckValueImpl typeCheckInstr
